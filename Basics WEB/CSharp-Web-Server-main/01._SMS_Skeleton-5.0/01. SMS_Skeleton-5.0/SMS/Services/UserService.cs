...
namespace SMS.Services
{
    public class UserService : IUserService
    {
        ...
        //private (bool registered, string error) ValidateRegisterModel(RegisterViewModel model)
        //{
        //    bool isValid = true;
        ...
        //    if (model == null)
        //    {
        //        return (false, "Register model is requred");
        //    }

        //    if (string.IsNullOrEmpty(model.Username) || model.Username.Length < 5 || model.Username.Length > 20)
        //    {
        //        isValid = false;
        //        error.AppendLine("Usename must be between 5 and 20 characters");
        //    }
        ...
        //    {
        //        isValid = false;
        //        error.AppendLine("Pasword must be between 6 and 20 characters");
        //    }

        //    if (model.Password != model.ConfirmPassword)
        //    {
        //        isValid = false;
        //        error.AppendLine("Pasword and ConfirmPassword must be equal");
        //    }
